...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    helpthehomelessd.spawn.datadir.should.equal(home + '/.helpthehomeless');
    helpthehomelessd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.helpthehomeless/helpthehomelessd'));
  });
