...
var readFileSync = sinon.stub().returns(fs.readFileSync(path.resolve(__dirname, '../data/helpthehomeless.conf')));
var HelpthehomelessService = proxyquire('../../lib/services/helpthehomelessd', {
  fs: {
    readFileSync: readFileSync
  }
});
var defaultHelpthehomelessConf = fs.readFileSync(path.resolve(__dirname, '../data/default.helpthehomeless.conf'), 'utf8');

describe('Helpthehomeless Service', function() {
  ...
  describe('@constructor', function() {
    it('will create an instance', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      should.exist(helpthehomelessd);
    });
    it('will create an instance without `new`', function() {
      var helpthehomelessd = HelpthehomelessService(baseConfig);
      should.exist(helpthehomelessd);
    });
  ...
  describe('@dependencies', function() {
    it('will have no dependencies', function() {
      HelpthehomelessService.dependencies.should.deep.equal([]);
    });
  });
  ...
  describe('#_getDefaultConfig', function() {
    it('will generate config file from defaults', function() {
      ...
      config.should.equal(defaultHelpthehomelessConf);
    });
  });
  ...
  describe('#_loadSpawnConfiguration', function() {
    ...
    it('will parse a helpthehomeless.conf file', function() {
      var TestHelpthehomeless = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
          readFileSync: readFileSync,
      ...
      var helpthehomelessd = new TestHelpthehomeless(baseConfig);
      helpthehomelessd.options.spawn.datadir = '/tmp/.helpthehomeless';
      var node = {};
    ...
    it('will expand relative datadir to absolute path', function() {
      ...
      var config = {
        node: {
          network: helpthehomeless.Networks.testnet,
          configPath: '/tmp/.helpthehomeless/helpthehomeless-node.json'
        },
        spawn: {
          datadir: './data',
          exec: 'testpath'
      ...
      var helpthehomelessd = new TestHelpthehomeless(config);
      helpthehomelessd.options.spawn.datadir = './data';
      var node = {};
      helpthehomelessd._loadSpawnConfiguration(node);
      helpthehomelessd.options.spawn.datadir.should.equal('/tmp/.helpthehomeless/data');
    });
    it('should throw an exception if txindex isn\'t enabled in the configuration', function() {
      var TestHelpthehomeless = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
          readFileSync: sinon.stub().returns(fs.readFileSync(__dirname + '/../data/badhelpthehomeless.conf')),
          existsSync: sinon.stub().returns(true),
        },
        mkdirp: {
          sync: sinon.stub()
      ...
      }).should.throw(helpthehomeless.errors.InvalidState);
    });
  ...
  describe('#_checkConfigIndexes', function() {
    ...
    it('should warn the user if reindex is set to 1 in the helpthehomeless.conf file', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var config = {
        txindex: 1,
        addressindex: 1,
  ...
  describe('#_getDefaultConf', function() {
    afterEach(function() {
      helpthehomeless.Networks.disableRegtest();
      baseConfig.node.network = helpthehomeless.Networks.testnet;
    });
    it('will get default rpc port for livenet', function() {
      ...
      var helpthehomelessd = new HelpthehomelessService(config);
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default rpc port for testnet', function() {
      ...
      var helpthehomelessd = new HelpthehomelessService(config);
      helpthehomelessd._getNetworkConfigPath().should.equal('testnet3/helpthehomeless.conf');
    });
    it('will get default rpc port for regtest', function() {
      helpthehomeless.Networks.enableRegtest();
      var config = {
      ...
      var helpthehomelessd = new HelpthehomelessService(config);
      helpthehomelessd._getNetworkConfigPath().should.equal('regtest/helpthehomeless.conf');
    });
  });
  ...
  describe('#_getNetworkOption', function() {
    ...
    it('return --testnet for testnet', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      helpthehomelessd.node.network = helpthehomeless.Networks.testnet;
    ...
    it('return undefined for livenet', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      helpthehomelessd.node.network = helpthehomeless.Networks.livenet;
      helpthehomeless.Networks.enableRegtest();
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using helpthehomeless.Transaction', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var wif = 'XGLgPK8gbmzU7jcbw34Pj55AXV7SmG6carKuiwtu4WtvTjyTbpwX';
      var privkey = helpthehomeless.PrivateKey.fromWIF(wif);
      var inputAddress = privkey.toAddress(helpthehomeless.Networks.testnet);
      var outputAddress = helpthehomeless.Address('8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi');
      var tx = helpthehomeless.Transaction();
      tx.from({
        txid: '4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b',
        outputIndex: 0,
        script: helpthehomeless.Script(inputAddress),
    ...
    it('will handle non-standard script types', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var tx = helpthehomeless.Transaction();
      tx.addInput(helpthehomeless.Transaction.Input({
        prevTxId: '4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b',
        script: helpthehomeless.Script('OP_TRUE'),
        outputIndex: 1,
        output: {
          script: helpthehomeless.Script('OP_TRUE'),
          satoshis: 5000000000
      ...
      tx.addOutput(helpthehomeless.Transaction.Output({
        script: helpthehomeless.Script('OP_TRUE'),
        satoshis: 5000000000
      }));
      var addresses = helpthehomelessd._getAddressesFromTransaction(tx);
    ...
    it('will return unique values', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var tx = helpthehomeless.Transaction();
      var address = helpthehomeless.Address('8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi');
      tx.addOutput(helpthehomeless.Transaction.Output({
        script: helpthehomeless.Script(address),
        satoshis: 5000000000
      }));
      tx.addOutput(helpthehomeless.Transaction.Output({
        script: helpthehomeless.Script(address),
  ...
  describe('#_stopSpawnedProcess', function() {
    ...
    it('it will kill process and resume', function(done) {
      ...
      var TestHelpthehomelessService = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
          readFile: readFile
        }
      });
      var helpthehomelessd = new TestHelpthehomelessService(baseConfig);
      helpthehomelessd.spawnStopTime = 1;
      helpthehomelessd._process = {};
      helpthehomelessd._process.kill = sinon.stub();
      helpthehomelessd._stopSpawnedHelpthehomeless(function(err) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_spawnChildProcess', function() {
    ...
    it('will give error from stopSpawnedHelpthehomeless', function() {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd._stopSpawnedHelpthehomeless = sinon.stub().callsArgWith(0, new Error('test'));
      helpthehomelessd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
      });
    ...
    it('will exit spawn if shutdown', function() {
      ...
      var helpthehomelessd = new TestHelpthehomelessService(config);
      helpthehomelessd.spawn = {};
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd._stopSpawnedHelpthehomeless = sinon.stub().callsArgWith(0, null);
      helpthehomelessd.node.stopping = true;
      helpthehomelessd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
    ...
    it('will include network with spawn command and init zmq/rpc on node', function(done) {
      ...
      helpthehomelessd.spawn.configPath = 'testdir/helpthehomeless.conf';
      helpthehomelessd.spawn.datadir = 'testdir';
      helpthehomelessd.spawn.config = {};
      helpthehomelessd.spawn.config.rpcport = 20001;
      helpthehomelessd.spawn.config.rpcuser = 'helpthehomeless';
      ...
      helpthehomelessd._spawnChildProcess(function(err, node) {
        ...
        spawn.args[0][1].should.deep.equal([
          '--conf=testdir/helpthehomeless.conf',
          '--datadir=testdir',
          '--testnet'
        ]);
    ...
    it('will respawn helpthehomelessd spawned process', function(done) {
      ...
      helpthehomelessd.spawn.datadir = '/tmp/helpthehomeless';
      helpthehomelessd.spawn.configPath = '/tmp/helpthehomeless/helpthehomeless.conf';
      helpthehomelessd.spawn.config = {};
      ...
      helpthehomelessd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      helpthehomelessd._stopSpawnedHelpthehomeless = sinon.stub().callsArg(0);
  ...
  describe('#start', function() {
    ...
    it('will give error if "spawn" and "connect" are both not configured', function(done) {
      ...
      helpthehomelessd.start(function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/Helpthehomeless configuration options/);
      });
      done();
    });
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from helpthehomeless addresses', function() {
      var addresses = [
        helpthehomeless.Address('XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN'),
        helpthehomeless.Address('7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz'),
      ];
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
  ...
  describe('#getBlock', function() {
    ...
    it('will getblock as helpthehomeless object from height', function(done) {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var getBlock = sinon.stub().callsArgWith(2, null, {
        result: blockhex
      });
      ...
      helpthehomelessd.getBlock(0, function(err, block) {
        ...
        block.should.be.instanceof(helpthehomeless.Block);
        done();
      });
    });
    it('will getblock as helpthehomeless object', function(done) {
      var helpthehomelessd = new HelpthehomelessService(baseConfig);
      var getBlock = sinon.stub().callsArgWith(2, null, {
        result: blockhex
      });
  ...
  describe('#sendTransaction', function(done) {
    var tx = helpthehomeless.Transaction(txhex);
  ...
  describe('#getTransaction', function() {
    ...
    it('will try all nodes', function(done) {
      ...
      helpthehomelessd.getTransaction('txid', function(err, tx) {
        ...
        should.exist(tx);
        tx.should.be.an.instanceof(helpthehomeless.Transaction);
        done();
      });
    });
    it('will get from cache', function(done) {
  ...
  describe('#govObject', function() {
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.helpthehomeless.org\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      helpthehomelessd.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.url, 'https://www.helpthehomeless.org');
        done();
      });
    });
