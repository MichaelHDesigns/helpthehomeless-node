...
var helpthehomelessnode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = helpthehomelessnode.version;
  var create = helpthehomelessnode.scaffold.create;
  var add = helpthehomelessnode.scaffold.add;
  var start = helpthehomelessnode.scaffold.start;
  var remove = helpthehomelessnode.scaffold.remove;
  var callMethod = helpthehomelessnode.scaffold.callMethod;
  var findConfig = helpthehomelessnode.scaffold.findConfig;
  var defaultConfig = helpthehomelessnode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Helpthehomeless database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make helpthehomeless-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `helpthehomeless-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ helpthehomeless-node add wallet-service');
      console.log('    $ helpthehomeless-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ helpthehomeless-node remove wallet-service');
      console.log('    $ helpthehomeless-node remove insight-api');
      console.log();
    });
